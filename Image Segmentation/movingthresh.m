...
%   neighbors. To reduce shading bias, the scanning is done in a zig-zag
%   manner, treating the pixels as if they were a 1-D, continous stream. If
%   the value of the image at a point exceeds K percent of the value of the
%   running average at that point, a 1 is output in that location in G.
...
% Flip every other row of f to produce the equivalent of a Zig-zag scaling
