...
%   [V, UNV] = STATMOMENTS(P, N) computes up to the Nth statistical central
%   moment of a histogram whose components are in vector P. The length of P
%   must equal 256 or 65536.
%
%   The program ouputs a vector V with V(1) = mean, V(2) = variance, V(3) =
%   3rd central moment, . . . V(N) = Nth central moment. The random
%   variable values are normalized to the range [0, 1], so all moments also
%   are in this range.
%
...
% Center random varibales about the mean.
z = z - m;
