...
%   input. GSCALE performs any necessary scaling. If the input is of class
%   double, and its values are not in the range [0, 1], then
...
switch method
    ...
    case 'minmax'
        ...
        % If the class of f is single or double
        low_in = min(f(:));
        high_in = max(f(:));
