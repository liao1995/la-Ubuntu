...
%HISTROI Computes the histogram of a ROI in an image.
...
%   the column and row coordinates of its vertices, which are specified
%   (sequentially) in vectors C and R, respectively. All pixels of F must
%   be >= 0. Parameter NPIX is the number of pixels in the polygonal
%   region.
